...
public class BetterRenderBlocks extends RenderBlocks {//useless dead code
    ...
    public BetterRenderBlocks(IBlockAccess world) {
     ...
     */
    @Override
    public void setOverrideBlockTexture(IIcon icon) {
     ...
     */
    public void renderBlockUsingTexture(Block block, int x, int y, int z, IIcon icon) {
    ...
    public boolean renderBlockByRenderType(Block block, int x, int y, int z) {
        ...
        if (renderType == -1) {
            ...
            //regex: ' : \(l == ([\d]+) \?' replace: ';\ncase \1: return' ::: IMPORTANT: REMEMBER THIS ON FIRST line!
            	...
            	case 3: 
            		return this.renderBlockFire((BlockFire)block, x, y, z) ;
            	case 4: 
            		return this.renderBlockLiquid(block, x, y, z) ;
            	case 5: 
            	...
            	case 9: 
            		return this.renderBlockMinecartTrack((BlockRailBase)block, x, y, z) ;
            	case 10: 
            		return this.renderBlockStairs((BlockStairs)block, x, y, z) ;
            	case 11: 
            		return this.renderBlockFence((BlockFence)block, x, y, z) ;
            	case 12: 
            	...
            	case 15: 
            		return this.renderBlockRepeater((BlockRedstoneRepeater)block, x, y, z) ;
            	case 16: 
            		return this.renderPistonBase(block, x, y, z, false) ;
            	case 17: 
            		return this.renderPistonExtension(block, x, y, z, true) ;
            	case 18: 
            		return this.renderBlockPane((BlockPane)block, x, y, z) ;
            	case 19: 
            		return this.renderBlockStem(block, x, y, z) ;
            	case 20: 
            		return this.renderBlockVine(block, x, y, z) ;
            	case 21: 
            		return this.renderBlockFenceGate((BlockFenceGate)block, x, y, z) ;
            	case 23: 
            		return this.renderBlockLilyPad(block, x, y, z) ;
            	case 24: 
            		return this.renderBlockCauldron((BlockCauldron)block, x, y, z) ;
            	case 25: 
            		return this.renderBlockBrewingStand((BlockBrewingStand)block, x, y, z) ;
            	case 26: 
            		return this.renderBlockEndPortalFrame((BlockEndPortalFrame)block, x, y, z) ;
              	case 27: 
            		return this.renderBlockDragonEgg((BlockDragonEgg)block, x, y, z) ;
            	case 28: 
            		return this.renderBlockCocoa((BlockCocoa)block, x, y, z) ;
            	case 29: 
            		return this.renderBlockTripWireSource(block, x, y, z) ;
            	case 30: 
            		return this.renderBlockTripWire(block, x, y, z) ;
            	case 31: 
            		return this.renderBlockLog(block, x, y, z) ;
            	case 32: 
            		return this.renderBlockWall((BlockWall)block, x, y, z) ;
            	case 33: 
            		return this.renderBlockFlowerpot((BlockFlowerPot)block, x, y, z) ;
            	case 34: 
            		return this.renderBlockBeacon((BlockBeacon)block, x, y, z) ;
            	case 35: 
            		return this.renderBlockAnvil((BlockAnvil)block, x, y, z) ;
            	case 36: 
            		return this.renderBlockRedstoneDiode((BlockRedstoneDiode)block, x, y, z) ;
            	case 37: 
            		return this.renderBlockRedstoneComparator((BlockRedstoneComparator)block, x, y, z) ;
            	case 38: 
            		return this.renderBlockHopper((BlockHopper)block, x, y, z);
            	case 39: 
            		return this.renderBlockQuartz(block, x, y, z) ;
            	case 40: 
            		return this.renderBlockDoublePlant((BlockDoublePlant)block, x, y, z) ;
            	case 41: 
            		return this.renderBlockStainedGlassPane(block, x, y, z) ;
            	default: 
            		return FMLRenderAccessLibrary.renderWorldBlock(this, blockAccess, x, y, z, block, renderType);
            }
        }
    }
    ...
    public boolean renderStandardBlock(Block block, int x, int y, int z) {
        int colourMultiplier = block.colorMultiplier(this.blockAccess, x, y, z);
        ...
        if(Minecraft.isAmbientOcclusionEnabled() && block.getLightValue() == 0) {
        	if(this.partialRenderBounds) {
        		return this.renderStandardBlockWithAmbientOcclusionPartial(block, x, y, z, red, green, blue);
        	} else {
    ...
    public boolean renderStandardBlockWithAmbientOcclusion(Block block, int x, int y, int z, float red, float green, float blue) {
        ...
        if (this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, x, y - 1, z, 0)) {
            ...
            if (flag1) {
                this.colorRedTopLeft = this.colorRedBottomLeft = this.colorRedBottomRight = this.colorRedTopRight = red * 0.5F;
                this.colorGreenTopLeft = this.colorGreenBottomLeft = this.colorGreenBottomRight = this.colorGreenTopRight = green * 0.5F;
                this.colorBlueTopLeft = this.colorBlueBottomLeft = this.colorBlueBottomRight = this.colorBlueTopRight = blue * 0.5F;
            } else {
     ...
     */
    public boolean renderStandardBlockWithAmbientOcclusionPartial(Block block, int x, int y, int z, float red, float green, float blue) {
        this.enableAO = true;
        boolean flag = false;
        float f3 = 0.0F;
        float f4 = 0.0F;
        ...
        if (this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, x, y - 1, z, 0)) {
            ...
            this.aoLightValueScratchYZNP = this.blockAccess.getBlock(x, y, z + 1).getAmbientOcclusionLightValue();
            this.aoLightValueScratchXYPN = this.blockAccess.getBlock(x + 1, y, z).getAmbientOcclusionLightValue();
            blocksGrassXPlusYMinus = this.blockAccess.getBlock(x + 1, y - 1, z).getCanBlockGrass();
            blocksGrassXMinusYMinus = this.blockAccess.getBlock(x - 1, y - 1, z).getCanBlockGrass();
            blocksGrassYMinusZPlus = this.blockAccess.getBlock(x, y - 1, z + 1).getCanBlockGrass();
            blocksGrassYMinusZMinus = this.blockAccess.getBlock(x, y - 1, z - 1).getCanBlockGrass();
            ...
            if (this.renderMinY <= 0.0D || !this.blockAccess.getBlock(x, y - 1, z).isOpaqueCube()) {
            	newBrightness = block.getMixedBrightnessForBlock(this.blockAccess, x, y - 1, z);
            }

            ambientOcclusionMinusY = this.blockAccess.getBlock(x, y - 1, z).getAmbientOcclusionLightValue();
            f3 = (this.aoLightValueScratchXYZNNP + this.aoLightValueScratchXYNN + this.aoLightValueScratchYZNP + ambientOcclusionMinusY) / 4.0F;
            f6 = (this.aoLightValueScratchYZNP + ambientOcclusionMinusY + this.aoLightValueScratchXYZPNP + this.aoLightValueScratchXYPN) / 4.0F;
            f5 = (ambientOcclusionMinusY + this.aoLightValueScratchYZNN + this.aoLightValueScratchXYPN + this.aoLightValueScratchXYZPNN) / 4.0F;
            f4 = (this.aoLightValueScratchXYNN + this.aoLightValueScratchXYZNNN + ambientOcclusionMinusY + this.aoLightValueScratchYZNN) / 4.0F;
            this.brightnessTopLeft = this.getAoBrightness(this.aoBrightnessXYZNNP, this.aoBrightnessXYNN, this.aoBrightnessYZNP, newBrightness);
            this.brightnessTopRight = this.getAoBrightness(this.aoBrightnessYZNP, this.aoBrightnessXYZPNP, this.aoBrightnessXYPN, newBrightness);
            this.brightnessBottomRight = this.getAoBrightness(this.aoBrightnessYZNN, this.aoBrightnessXYPN, this.aoBrightnessXYZPNN, newBrightness);
            this.brightnessBottomLeft = this.getAoBrightness(this.aoBrightnessXYNN, this.aoBrightnessXYZNNN, this.aoBrightnessYZNN, newBrightness);
        ...
        if (this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, x, y + 1, z, 1)) {
            ...
            ambientOcclusionMinusY = this.blockAccess.getBlock(x, y + 1, z).getAmbientOcclusionLightValue();
            f6 = (this.aoLightValueScratchXYZNPP + this.aoLightValueScratchXYNP + this.aoLightValueScratchYZPP + ambientOcclusionMinusY) / 4.0F;
            f3 = (this.aoLightValueScratchYZPP + ambientOcclusionMinusY + this.aoLightValueScratchXYZPPP + this.aoLightValueScratchXYPP) / 4.0F;
            f4 = (ambientOcclusionMinusY + this.aoLightValueScratchYZPN + this.aoLightValueScratchXYPP + this.aoLightValueScratchXYZPPN) / 4.0F;
            f5 = (this.aoLightValueScratchXYNP + this.aoLightValueScratchXYZNPN + ambientOcclusionMinusY + this.aoLightValueScratchYZPN) / 4.0F;
            this.brightnessTopRight = this.getAoBrightness(this.aoBrightnessXYZNPP, this.aoBrightnessXYNP, this.aoBrightnessYZPP, newBrightness);
            this.brightnessTopLeft = this.getAoBrightness(this.aoBrightnessYZPP, this.aoBrightnessXYZPPP, this.aoBrightnessXYPP, newBrightness);
            this.brightnessBottomLeft = this.getAoBrightness(this.aoBrightnessYZPN, this.aoBrightnessXYPP, this.aoBrightnessXYZPPN, newBrightness);
            this.brightnessBottomRight = this.getAoBrightness(this.aoBrightnessXYNP, this.aoBrightnessXYZNPN, this.aoBrightnessYZPN, newBrightness);
            this.colorRedTopLeft = this.colorRedBottomLeft = this.colorRedBottomRight = this.colorRedTopRight = red;
            this.colorGreenTopLeft = this.colorGreenBottomLeft = this.colorGreenBottomRight = this.colorGreenTopRight = green;
            this.colorBlueTopLeft = this.colorBlueBottomLeft = this.colorBlueBottomRight = this.colorBlueTopRight = blue;
            this.colorRedTopLeft *= f3;
        ...
        if (this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, x, y, z - 1, 2)) {
            ...
            this.aoBrightnessYZPN = block.getMixedBrightnessForBlock(this.blockAccess, x, y + 1, z);
            this.aoBrightnessXZPN = block.getMixedBrightnessForBlock(this.blockAccess, x + 1, y, z);
            blocksGrassXPlusYMinus = this.blockAccess.getBlock(x + 1, y, z - 1).getCanBlockGrass();
            blocksGrassXMinusYMinus = this.blockAccess.getBlock(x - 1, y, z - 1).getCanBlockGrass();
            blocksGrassYMinusZPlus = this.blockAccess.getBlock(x, y + 1, z - 1).getCanBlockGrass();
            blocksGrassYMinusZMinus = this.blockAccess.getBlock(x, y - 1, z - 1).getCanBlockGrass();
            ...
            if (this.renderMinZ <= 0.0D || !this.blockAccess.getBlock(x, y, z - 1).isOpaqueCube()) {
            	newBrightness = block.getMixedBrightnessForBlock(this.blockAccess, x, y, z - 1);
            }

            ambientOcclusionMinusY = this.blockAccess.getBlock(x, y, z - 1).getAmbientOcclusionLightValue();
            f8 = (this.aoLightValueScratchXZNN + this.aoLightValueScratchXYZNPN + ambientOcclusionMinusY + this.aoLightValueScratchYZPN) / 4.0F;
            f9 = (ambientOcclusionMinusY + this.aoLightValueScratchYZPN + this.aoLightValueScratchXZPN + this.aoLightValueScratchXYZPPN) / 4.0F;
            f10 = (this.aoLightValueScratchYZNN + ambientOcclusionMinusY + this.aoLightValueScratchXYZPNN + this.aoLightValueScratchXZPN) / 4.0F;
            f11 = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXZNN + this.aoLightValueScratchYZNN + ambientOcclusionMinusY) / 4.0F;
            ...
            j1 = this.getAoBrightness(this.aoBrightnessXZNN, this.aoBrightnessXYZNPN, this.aoBrightnessYZPN, newBrightness);
            k1 = this.getAoBrightness(this.aoBrightnessYZPN, this.aoBrightnessXZPN, this.aoBrightnessXYZPPN, newBrightness);
            l1 = this.getAoBrightness(this.aoBrightnessYZNN, this.aoBrightnessXYZPNN, this.aoBrightnessXZPN, newBrightness);
            i2 = this.getAoBrightness(this.aoBrightnessXYZNNN, this.aoBrightnessXZNN, this.aoBrightnessYZNN, newBrightness);
        ...
        if (this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, x, y, z + 1, 3)) {
            ...
            ambientOcclusionMinusY = this.blockAccess.getBlock(x, y, z + 1).getAmbientOcclusionLightValue();
            f8 = (this.aoLightValueScratchXZNP + this.aoLightValueScratchXYZNPP + ambientOcclusionMinusY + this.aoLightValueScratchYZPP) / 4.0F;
            f9 = (ambientOcclusionMinusY + this.aoLightValueScratchYZPP + this.aoLightValueScratchXZPP + this.aoLightValueScratchXYZPPP) / 4.0F;
            f10 = (this.aoLightValueScratchYZNP + ambientOcclusionMinusY + this.aoLightValueScratchXYZPNP + this.aoLightValueScratchXZPP) / 4.0F;
            f11 = (this.aoLightValueScratchXYZNNP + this.aoLightValueScratchXZNP + this.aoLightValueScratchYZNP + ambientOcclusionMinusY) / 4.0F;
            f3 = (float)((double)f8 * this.renderMaxY * (1.0D - this.renderMinX) + (double)f9 * this.renderMaxY * this.renderMinX + (double)f10 * (1.0D - this.renderMaxY) * this.renderMinX + (double)f11 * (1.0D - this.renderMaxY) * (1.0D - this.renderMinX));
            ...
            j1 = this.getAoBrightness(this.aoBrightnessXZNP, this.aoBrightnessXYZNPP, this.aoBrightnessYZPP, newBrightness);
            k1 = this.getAoBrightness(this.aoBrightnessYZPP, this.aoBrightnessXZPP, this.aoBrightnessXYZPPP, newBrightness);
            l1 = this.getAoBrightness(this.aoBrightnessYZNP, this.aoBrightnessXYZPNP, this.aoBrightnessXZPP, newBrightness);
            i2 = this.getAoBrightness(this.aoBrightnessXYZNNP, this.aoBrightnessXZNP, this.aoBrightnessYZNP, newBrightness);
        ...
        if (this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, x - 1, y, z, 4)) {
            ...
            blocksGrassXPlusYMinus = this.blockAccess.getBlock(x - 1, y + 1, z).getCanBlockGrass();
            blocksGrassXMinusYMinus = this.blockAccess.getBlock(x - 1, y - 1, z).getCanBlockGrass();
            blocksGrassYMinusZPlus = this.blockAccess.getBlock(x - 1, y, z - 1).getCanBlockGrass();
            blocksGrassYMinusZMinus = this.blockAccess.getBlock(x - 1, y, z + 1).getCanBlockGrass();
            ...
            if (this.renderMinX <= 0.0D || !this.blockAccess.getBlock(x - 1, y, z).isOpaqueCube()) {
            	newBrightness = block.getMixedBrightnessForBlock(this.blockAccess, x - 1, y, z);
            }

            ambientOcclusionMinusY = this.blockAccess.getBlock(x - 1, y, z).getAmbientOcclusionLightValue();
            f8 = (this.aoLightValueScratchXYNN + this.aoLightValueScratchXYZNNP + ambientOcclusionMinusY + this.aoLightValueScratchXZNP) / 4.0F;
            f9 = (ambientOcclusionMinusY + this.aoLightValueScratchXZNP + this.aoLightValueScratchXYNP + this.aoLightValueScratchXYZNPP) / 4.0F;
            f10 = (this.aoLightValueScratchXZNN + ambientOcclusionMinusY + this.aoLightValueScratchXYZNPN + this.aoLightValueScratchXYNP) / 4.0F;
            f11 = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXYNN + this.aoLightValueScratchXZNN + ambientOcclusionMinusY) / 4.0F;
            ...
            j1 = this.getAoBrightness(this.aoBrightnessXYNN, this.aoBrightnessXYZNNP, this.aoBrightnessXZNP, newBrightness);
            k1 = this.getAoBrightness(this.aoBrightnessXZNP, this.aoBrightnessXYNP, this.aoBrightnessXYZNPP, newBrightness);
            l1 = this.getAoBrightness(this.aoBrightnessXZNN, this.aoBrightnessXYZNPN, this.aoBrightnessXYNP, newBrightness);
            i2 = this.getAoBrightness(this.aoBrightnessXYZNNN, this.aoBrightnessXYNN, this.aoBrightnessXZNN, newBrightness);
        ...
        if (this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, x + 1, y, z, 5)) {
            ...
            ambientOcclusionMinusY = this.blockAccess.getBlock(x + 1, y, z).getAmbientOcclusionLightValue();
            f8 = (this.aoLightValueScratchXYPN + this.aoLightValueScratchXYZPNP + ambientOcclusionMinusY + this.aoLightValueScratchXZPP) / 4.0F;
            f9 = (this.aoLightValueScratchXYZPNN + this.aoLightValueScratchXYPN + this.aoLightValueScratchXZPN + ambientOcclusionMinusY) / 4.0F;
            f10 = (this.aoLightValueScratchXZPN + ambientOcclusionMinusY + this.aoLightValueScratchXYZPPN + this.aoLightValueScratchXYPP) / 4.0F;
            f11 = (ambientOcclusionMinusY + this.aoLightValueScratchXZPP + this.aoLightValueScratchXYPP + this.aoLightValueScratchXYZPPP) / 4.0F;
            ...
            j1 = this.getAoBrightness(this.aoBrightnessXYPN, this.aoBrightnessXYZPNP, this.aoBrightnessXZPP, newBrightness);
            k1 = this.getAoBrightness(this.aoBrightnessXZPP, this.aoBrightnessXYPP, this.aoBrightnessXYZPPP, newBrightness);
            l1 = this.getAoBrightness(this.aoBrightnessXZPN, this.aoBrightnessXYZPPN, this.aoBrightnessXYPP, newBrightness);
            i2 = this.getAoBrightness(this.aoBrightnessXYZPNN, this.aoBrightnessXYPN, this.aoBrightnessXZPN, newBrightness);
     ...
     */
    public void renderBlockAsItem(Block block, int meta, float par3) {
        Tessellator tessellator = Tessellator.instance;
        ...
        if (this.useInventoryTint) {
            renderColour = block.getRenderColor(meta);

            f1 = (float)(renderColour >> 16 & 255) / 255.0F;
            f2 = (float)(renderColour >> 8 & 255) / 255.0F;
            f3 = (float)(renderColour & 255) / 255.0F;
            GL11.glColor4f(f1 * par3, f2 * par3, f3 * par3, 1.0F);
        }

        renderColour = block.getRenderType();
        this.setRenderBoundsFromBlock(block);
        int k;

        if (renderColour != 0 && renderColour != 31 && renderColour != 39 && renderColour != 16 && renderColour != 26) {
            if (renderColour == 1) {
                tessellator.startDrawingQuads();
                tessellator.setNormal(0.0F, -1.0F, 0.0F);
            ...
            else if (renderColour == 22)
            {
                GL11.glRotatef(90.0F, 0.0F, 1.0F, 0.0F);
                GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
                TileEntityRendererChestHelper.instance.renderChest(block, meta, par3);
                GL11.glEnable(GL12.GL_RESCALE_NORMAL);
            }
            else if (renderColour == 6)
            {
                tessellator.startDrawingQuads();
                tessellator.setNormal(0.0F, -1.0F, 0.0F);
            ...
            {
                FMLRenderAccessLibrary.renderInventoryBlock(this, block, meta, renderColour);
            }
        } else {
            if (renderColour == 16) {
                meta = 1;
    ...
    public IIcon getBlockIcon(Block block, IBlockAccess world, int x, int y, int z, int side) {
        return this.getIconSafe(block.getIcon(world, x, y, z, side));
    }
    ...
    /*==================================== FORGE START ===========================================*/
    private static BetterRenderBlocks instance;
    /**
     ...
     */
    public static BetterRenderBlocks getInstance()
    {
        if (instance == null) instance = new BetterRenderBlocks();
        return instance;
    }
    /*==================================== FORGE END =============================================*/
}