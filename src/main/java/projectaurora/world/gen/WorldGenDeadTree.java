...
public class WorldGenDeadTree extends WorldGenAbstractTree {
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
	    ...
	    if ((!below.canSustainPlant(world, x, y - 1, z, ForgeDirection.UP, (IPlantable)Blocks.sapling)) && (below != Blocks.stone) && (below != Blocks.sand) && (below != Blocks.gravel)) { //TODO other types of saplings?
	    	return false;
	    }
